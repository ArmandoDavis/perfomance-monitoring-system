...
namespace App\Http\Controllers\Hod\Task;
...
class TaskController extends Controller
{
    ...
    {
        return view('pages.hod.task.index');
    }

    public function myTasks() {
        return view('pages.hod.task.index', ['filter_type' => 'my_tasks']);
    }

    public function shared() {
        return view('pages.hod.task.index', ['filter_type' => 'shared']);
    }

    public function nextActions() {
        return view('pages.hod.task.index', ['filter_type' => 'next_actions']);
    }

    public function transferred() {
        return view('pages.hod.task.index', ['filter_type' => 'transferred']);
    }
    ...
    public function store(TaskRequest $request)
    {
        ...
        return redirect()->route('hod_panel.tasks.profile', compact('task'))->with('flash_success', 'Task created successfully');
    }
    ...
    public function profile(Task $task)
    {
        ...
        $codeId = $this->codeRepository->getOnlyCodeIdByNameForCodeValue('Status');
        ...
        return view('pages.hod.task.profile.profile', $data);
    }
    ...
    public function delete(Task $task)
    {
        ...
        return redirect()->route('hod_panel.tasks.index')->with('flash_success', 'Task Deleted successfully');
    }

    public function archive(Task $task)
    {
        $this->taskRepository->archive($task);
        return redirect()->route('hod_panel.tasks.index')->with('flash_success', 'Task archived successfully');
    }
    ...
    public function getAllForDt(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('is_active_badge', fn($task) => getStatusBadge($task->is_active))
            ->rawColumns(['status_badge', 'is_active_badge'])->make(true);
    }
}
