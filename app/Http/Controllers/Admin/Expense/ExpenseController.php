...
class ExpenseController extends Controller
{
    ...
    {
        $tasks = $this->taskRepository->getTasksToBeAddedExpense();
        return view('pages.admin.expenses.create', compact('tasks'));
    }

    public function profile(Expense $expense)
    {
        return view('pages.admin.expenses.profile.profile', compact('expense'));
    }
    ...
    {
        $tasks = $this->taskRepository->getTasksToBeAddedExpense();
        return view('pages.admin.expenses.edit', compact('expense', 'tasks'));
    }
    ...
    public function update(ExpenseRequest $request, Expense $expense)
    {
        ...
        return redirect()->back()->with('flash_success', __('Expense update successfully'));
    }
