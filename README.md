...
18. When the head of department logs in, in creating the task the form should return his/her department automatically => Done
19. Same for the assigning of users, he should assign users in that specific department only. => Done
...
21. The Expenses section is not connected yet.  => Done
