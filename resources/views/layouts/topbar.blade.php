    ...
    <nav class="navbar navbar-expand align-items-center gap-4">
        ...
        <div class="search-bar flex-grow-1">
            <div class="position-relative">
                <input id="global-search-input" class="form-control rounded-5 px-5 search-control d-lg-block d-none" type="text" placeholder="Search tasks...">
                    ...
                    <div class="card rounded-4 overflow-hidden">
                        ...
                        <div class="card-body search-content">
                            ...
                            <div id="global-search-results" class="search-list d-flex flex-column gap-2">
                                <div class="text-muted small">Type to search tasks...</div>
                            </div>
                        </div>
        ...
        <ul class="navbar-nav gap-1 nav-right-links align-items-center">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
                    ...
                    <hr class="dropdown-divider">
                    <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('frontend.audits.my_logs') }}">
