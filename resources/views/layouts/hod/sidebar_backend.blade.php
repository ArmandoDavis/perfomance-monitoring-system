            ...
            @can('task.view')
                ...
                <li>
                    ...
                    <ul>
                        @can('task.manage')
                            <li>
                                <a href="{{ route('hod_panel.tasks.index') }}">
                        ...
                        <li>
                            <a href="{{ route('hod_panel.tasks.my_tasks') }}">
                                <i class="fas fa-user-gear"></i> My Tasks
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('hod_panel.tasks.shared') }}">
                                <i class="fas fa-users-viewfinder"></i> Shared Tasks
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('hod_panel.tasks.next_actions') }}">
                                <i class="fas fa-calendar-check"></i> Next Actions
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('hod_panel.tasks.transferred') }}">
            ...
            @canany(['user.view', 'expense.view'])
                ...
                <li>
                    ...
                    <ul>
                        ...
                        @can('user.view')
                            <li>
                                <a href="{{ route('hod_panel.users.index') }}">
