...
@section('content')
                ...
                <div class="card shadow">
                    <div class="card-body text-center">
                        ...
                        <div class="row text-center">
                            <div class="col">
                                <h6 class="fw-bold">{{ $taskCount ?? 0 }}</h6>
                                <small class="text-muted">{{ __('Tasks') }}</small>
                            </div>
                            <div class="col">
                                <h6 class="fw-bold">{{ $completedTasks ?? 0 }}</h6>
                                <small class="text-muted">{{ __('Completed') }}</small>
                            </div>
                            <div class="col">
                                <h6 class="fw-bold">{{ number_2_format($totalExpenses ?? 0) }}</h6>
    ...
    @include('pages.frontend.user_profile.partial.modal')
@endsection
