        ...
        <div class="card-body">
            ...
            <div class="tab-content text-muted">
                <div class="tab-pane fade show active" id="general_tab" role="tabpanel">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-end flex-wrap gap-2">
                                @if(!$expense->approved_at)
                                    <form action="{{ route('hod_panel.expenses.approve', $expense->uuid) }}" method="POST" class="d-none confirm-form-approve-{{ $expense->uuid }}">
                                        @csrf
                                        @method('PUT')
                                    </form>
                                ...
                                <a href="{{ route('hod_panel.expenses.index') }}" class="btn btn-sm btn-dark mb-2 mr-2" >
                    ...
                    @include('pages.hod.expenses.profile.includes.general_info')
                </div>
            </div>
        </div>
    </div>
