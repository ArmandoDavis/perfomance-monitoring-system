...
@section('content')
    <div class="col-lg-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('hod_panel.tasks.update', $task->uuid) }}" name="update">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" rows="4" class="form-control ckeditor @error('description') is-invalid @enderror">{{ old('description', $task->description) }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" name="allocated_budget" id="allocated_budget" value="{{ old('allocated_budget', $task->allocated_budget) }}" class="form-control @error('allocated_budget') is-invalid @enderror">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="mb-3">
                                    ...
                                    <select name="status_cv_id" id="status_cv_id" class="form-select @error('status_cv_id') is-invalid @enderror">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="start_date" id="start_date" value="{{ old('start_date', short_date_format($task->start_date)) }}" class="form-control datepicker2 @error('start_date') is-invalid @enderror">
                            @error('start_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="end_date" id="end_date" value="{{ old('end_date', short_date_format($task->end_date)) }}" class="form-control datepicker_after_today @error('end_date') is-invalid @enderror">
                            @error('end_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('hod_panel.tasks.profile', $task->uuid) }}" class="btn btn-light">
                            {{ __('Cancel') }}
                        </a>

                        <button type="submit" class="btn btn-primary" id="submit_btn">{{ __('Update') }}
